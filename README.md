...
PS: the API has limits for how many stocks can be added every minute, so you may have to wait a few seconds if you add too many and get an alert stating the stock was not added. 
